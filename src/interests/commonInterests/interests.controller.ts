...
@Controller('api/interests/common')
export class InterestsController {
  ...
  async findByParentid(@Param('parentId') parentId: string): Promise<InterestDto> {
    return await this.interestService.getByParentId(parentId);
  }
