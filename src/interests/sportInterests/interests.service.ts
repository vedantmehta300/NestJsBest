...
export class InterestsService {
  constructor(
    @InjectRepository(SportInterestsEntity)
    private interestsRepository: Repository<SportInterestsEntity>,
  ) {}
  ...
  async getOneInterest(id: string): Promise<InterestDto> {
